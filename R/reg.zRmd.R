...
"data. To generalize to forecasting accuracy on _new_ data, base the fit ",
"of the model to forecasts on the _predictive residual_ (PRE). ",
...
"is an interesting and perhaps useful heuristic, but should not be ",
